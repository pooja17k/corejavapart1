...
public class Col {
    public static List<String> printUniqueCities (List<Trader> traders) {
        ...
        System.out.println("2"+uniqueList);
    ...
    public static List<String> trader2sFromPuneSortByName(List<Trader> traders) {
        ...
        System.out.println("1"+uniqueList);
        return  uniqueList;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("3"+allTrader3Names(traders));
        System.out.println("4"+areAnyTrader4sFromIndore(traders1));
    }
}